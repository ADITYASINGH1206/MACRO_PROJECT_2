    ...
    return (
      <div className={`${styles.surface} min-h-screen flex flex-col items-center justify-center gap-8`}>
        ...
        <div className="text-center">
            <p className={`${styles.textPrimary} font-black text-xs uppercase tracking-[0.4em] mb-2`}>VeriFace</p>
            <p className={`${styles.textSecondary} text-[10px] font-bold uppercase tracking-[0.2em] animate-pulse`}>Syncing data...</p>
        </div>
      </div>
    );
  }
      ...
      <header className="fixed top-0 w-full z-50 bg-opacity-80 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-8 py-5">
        <div className="flex items-center gap-5">
          ...
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#8083ff] to-[#c0c1ff] flex items-center justify-center shadow-lg shadow-[#8083ff]/20 overflow-hidden">
            {user?.avatar_url ? (
              <img alt="User" className="w-full h-full object-cover" src={user.avatar_url}/>
            ) : (
          ...
          <div className="hidden lg:block">
            ...
            <p className={`text-[10px] ${styles.textSecondary} font-bold tracking-[0.2em] mt-1.5 uppercase`}>Student Portal</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
             <div className="text-right hidden sm:block">
                ...
                <p className={`text-[9px] ${styles.accentSecondary} font-bold uppercase tracking-widest`}>Active Session</p>
             </div>
