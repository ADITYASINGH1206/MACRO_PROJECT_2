      ...
      <header className="fixed top-0 w-full z-50 backdrop-blur-xl border-b border-white/10 flex items-center justify-between px-8 py-5" style={{backgroundColor: isDarkMode ? 'rgba(10,15,28,0.9)' : 'rgba(248,249,252,0.9)', boxShadow: '0 1px 24px rgba(0,0,0,0.3)'}}>
        <div className="flex items-center gap-5">
          ...
          <div className="hidden lg:block">
            <h1 className="text-lg font-black tracking-tighter uppercase leading-none">Veri<span className={styles.accentPrimary}>Face</span> Admin</h1>
            <p className={`text-[10px] ${styles.textSecondary} font-bold tracking-widest mt-1 uppercase`}>System Administration</p>
          </div>
        </div>
          ...
          <div className="animate-fade-up space-y-12">
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className={`${styles.surfaceLow} p-10 rounded-[2rem] border border-white/[0.07] shadow-premium hover:shadow-premium-lg space-y-6 relative overflow-hidden group transition-all duration-200`}>
                ...
                <h3 className={`text-[10px] font-black uppercase tracking-[0.2em] ${styles.textSecondary}`}>Course Statistics</h3>
              ...
              <div className={`${styles.surfaceLow} p-10 rounded-[2rem] border border-white/[0.07] shadow-premium hover:shadow-premium-lg space-y-6 relative overflow-hidden group transition-all duration-200`}>
                ...
                <h3 className={`text-[10px] font-black uppercase tracking-[0.2em] ${styles.textSecondary}`}>Faculty Statistics</h3>
                <div className="flex items-end gap-3">
                  <p className={`text-6xl font-black tracking-tighter italic ${styles.accentSecondary}`}>12</p>
                  <p className={`text-sm ${styles.textSecondary} mb-2`}>Faculty Members</p>
                </div>
              </div>
              ...
              <div className={`${styles.surfaceLow} p-10 rounded-[2rem] border border-white/[0.07] shadow-premium flex flex-col justify-between transition-all duration-200 group`}>
                <div>
                   <h3 className="text-xl font-black tracking-tight leading-none mb-3">Quick<br/>Actions</h3>
                   <p className={`${styles.textSecondary} text-xs leading-relaxed`}>Manage system users and academic courses efficiently.</p>
                </div>
            ...
            <section className={`${styles.surfaceLow} rounded-[2.5rem] p-12 border border-white/5 shadow-2xl relative overflow-hidden`}>
                <div className="flex items-center justify-between mb-12">
                   <div>
                      <h2 className="text-3xl font-black tracking-tight leading-none mb-2">System Overview</h2>
                      <p className={`${styles.textSecondary} text-sm`}>Overview of all courses and faculty.</p>
                   </div>
