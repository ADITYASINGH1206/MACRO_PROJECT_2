      ...
      <div className="max-w-[1200px] mx-auto space-y-12">
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/5 pb-8">
          <div className="flex-1">
            ...
            <p className={`${styles.textSecondary} text-lg font-light mt-4`}>The historical log of all attendance records.</p>
          </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/5">
                <th className="px-10 py-8 text-[11px] font-black uppercase tracking-[0.3em] opacity-30">Student</th>
                <th className="px-10 py-8 text-[11px] font-black uppercase tracking-[0.3em] opacity-30">Status</th>
                <th className="px-10 py-8 text-[11px] font-black uppercase tracking-[0.3em] opacity-30">Course</th>
                ...
                <tr key={idx} className="border-b border-white/5 last:border-0 hover:bg-white/[0.02] transition-all group">
                  ...
                  <td className="px-10 py-8">
                     <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[10px] opacity-30">school</span>
                        <p className={`text-[10px] font-black uppercase tracking-widest`}>
                           {log.courses?.name || 'General'}<br/>
                           <span className="opacity-40 text-[9px]">{log.courses?.code || '---'}</span>
                        </p>
                     </div>
                  </td>
