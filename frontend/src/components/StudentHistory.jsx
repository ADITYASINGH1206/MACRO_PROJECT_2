    ...
    <div className="max-w-[1200px] mx-auto space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-white/5 pb-8">
        <div>
          ...
          <p className={`${styles.textSecondary} text-lg font-light mt-4`}>The record of all your attendance sessions.</p>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className={styles.surfaceContainer}>
              <tr>
                <th className="px-10 py-8 text-[11px] font-black uppercase tracking-[0.3em] opacity-40">Date & Time</th>
                <th className="px-10 py-8 text-[11px] font-black uppercase tracking-[0.3em] opacity-40">Course Session</th>
                <th className="px-10 py-8 text-[11px] font-black uppercase tracking-[0.3em] opacity-40">Status</th>
              </tr>
            </thead>
                  ...
                  <tr key={idx} className="hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td className="px-10 py-8">
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             <p className="text-sm font-black tracking-tight">{log.courses?.name || 'Attendance Session'}</p>
                             <p className={`text-[10px] ${styles.textSecondary} font-bold opacity-60 uppercase tracking-widest`}>{log.courses?.code || 'General'}</p>
                          </div>
                       </div>
                    </td>
                    <td className="px-10 py-8">
