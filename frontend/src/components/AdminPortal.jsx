    ...
    <div className={`min-h-screen ${styles.surface} ${styles.textPrimary} font-inter p-12 space-y-16`}>
      <header className="flex items-center justify-between">
         <div className="flex items-center gap-6">
            ...
            <div>
               <h2 className="text-4xl font-black tracking-tight">System Management</h2>
               <p className={`${styles.textSecondary} text-sm font-light mt-1`}>Authorized Management of System Users and Courses.</p>
            </div>
         </div>
      </header>
      ...
      <section className="grid grid-cols-1 xl:grid-cols-2 gap-12">
        ...
        <div className={`${styles.surfaceLow} p-12 rounded-[2.5rem] border border-white/5 shadow-2xl`}>
           <div className="flex items-center justify-between mb-10">
              <h3 className="text-2xl font-black tracking-tight">Faculty Members</h3>
