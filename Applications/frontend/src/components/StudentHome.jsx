  ...
  return (
    <div className="bg-background text-on-surface min-h-screen pb-24 selection:bg-primary/30">
      ...
      <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center px-6 py-4 pb-safe bg-background/95 backdrop-blur-xl z-50 border-t border-outline/20">
        <div className="flex flex-col items-center justify-center text-primary group transition-all" onClick={() => setCurrentTab('home')}>
        ...
        <div className="flex flex-col items-center justify-center text-on-surface-variant hover:text-on-surface transition-all cursor-pointer" onClick={() => setCurrentTab('history')}>
        ...
        <div className="flex flex-col items-center justify-center text-on-surface-variant hover:text-on-surface transition-all cursor-pointer" onClick={() => setCurrentTab('courses')}>
        ...
        <div className="flex flex-col items-center justify-center text-on-surface-variant hover:text-on-surface transition-all cursor-pointer" onClick={() => setCurrentTab('profile')}>
